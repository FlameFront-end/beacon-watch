...
type MailsDashboardPageProps = {
  readonly serviceKey: ServiceKey;
};

export function MailsDashboardPage({ serviceKey }: MailsDashboardPageProps): JSX.Element {
  const dashboard = useMailsDashboard(serviceKey);
